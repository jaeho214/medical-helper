...
public class EmergencySeriousIllnessService {
    private final ApiConnection apiConnection;
    private final XmlParser xmlParser;
    private final String serviceKey = "";

    public Map<String, Object> selectSeriousIllness(String stage1, String stage2) {
        Map<String, Object> seriousIllness = new HashMap<>();
        StringBuilder url = new StringBuilder();
        ///String code = "Y000";
        try{

            url.append("http://apis.data.go.kr/B552657/ErmctInfoInqireService/getSrsillDissAceptncPosblInfoInqire");
        ...
        seriousIllness = xmlParser.xmlToJson(result.toString());
